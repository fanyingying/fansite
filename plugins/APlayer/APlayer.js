...
APlayer.prototype.init = function () {
    ...
    this.element.innerHTML = ''
        ...
        +     '</div>' 
        +     '<div class="music-sonic aplayer-hide">' 
        +     '</div>'
        +     '<div class="aplayer-button aplayer-play">'
        +         '<i class="demo-icon aplayer-icon-play"></i>'
        +     '</div>'
        +     '<div class="music-static">' 
        +     '</div>'
        + '</div>'
    ...
    //音乐图标
    this.musicStatic  = this.element.getElementsByClassName('music-static')[0];
    this.musicSonic = this.element.getElementsByClassName('music-sonic')[0];
...
APlayer.prototype.play = function () {
    ...
    this.musicStatic.classList.add('aplayer-hide');
    this.musicSonic.classList.remove('aplayer-hide');
...
APlayer.prototype.pause = function () {
    ...
    this.musicStatic.classList.remove('aplayer-hide');
    this.musicSonic.classList.add('aplayer-hide');
    this.audio.pause();
